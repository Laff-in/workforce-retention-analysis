...
This dataset is a fictional project dataset. Employee names have been anonymized in the public version of this data (`data/clean_data.csv`) as standard practice for any HR dataset, real or simulated.
